			...
			try {
	            ...
	            try {
	            	...
	            	if(main.maintasklist.size()<1){
	            		...
	            		fos.write(restring.getBytes());
	            		restring=df.format(tta.getOffloadsize())+"   "+df.format(tta.getRevolution())+"   "+df.format(tta.getKt())+"   "+df.format(tta.getKe())+"   "+df.format(tta.getVehicleability())+"   "+df.format(tta.getUavability())+"   "+df.format(tta.getBsability())+"   "+df.format(tta.getV2bdistance())+"   "+df.format(tta.getHavebuilding())+"   "+df.format(tta.getV2udistance())+"   "+df.format(tta.getU2bdistance())+"   "+df.format(tta.getBand())+"   "+df.format(tta.getTransmissionpower())+"   "+df.format(tta.getBackgroundnoise())+"   "+df.format(tta.getV2bchannelgain())+"   "+df.format(tta.getV2uchannelgain())+"   "+df.format(tta.getUsende())+"   "+df.format(tta.getVsende())+"   "+df.format(tta.getUcalcue())+"   "+df.format(tta.getVcalcue())+"   "+tta.getDec().de+"\r\n";
